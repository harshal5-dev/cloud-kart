package com.cloudkart.user_auth_service.dto;

import com.cloudkart.user_auth_service.entity.AddressType;
...
public class AddressRequest {
        ...
        @Schema(description = "Type of address, e.g., HOME, OFFICE, BILLING, SHIPPING",
                        example = "HOME", allowableValues = "HOME, OFFICE, BILLING, SHIPPING")
