...
public class PublicProductController {
  ...
  // @Operation(summary = "Fetch Product Details REST API", description = "REST API to fetch Product
  // details based on a slug")
  // @ApiResponses({
  // @ApiResponse(responseCode = "200", description = "HTTP Status OK", content = @Content(schema =
  ...
  // ResponseDto<ProductDto> responseDto = new ResponseDto<>(HttpStatus.OK, product,
  // ProductConstants.MESSAGE_FETCHED);
