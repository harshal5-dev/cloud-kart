...
public class PublicCategoryController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "500", description = "HTTP Status Internal Server Error",
                    content = @Content(schema = @Schema(implementation = ErrorResponseDto.class)))})
    @GetMapping("/{slug}")
    public ResponseEntity<ResponseDto<CategoryResDto>> getCategoryBySlug(
    ...
    public ResponseEntity<PagedResDto<ProductResDto>> getProductsByCategoryPaginated(
        ...
        PagedResDto<ProductResDto> products = iPublicProductService.searchProducts(slug, keyword,
