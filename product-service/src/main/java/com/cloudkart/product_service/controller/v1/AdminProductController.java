...
public class AdminProductController {
    ...
    public ResponseEntity<ResponseDto<ProductDto>> createProduct(
        ...
        ResponseDto<ProductDto> responseDto = new ResponseDto<>(HttpStatus.CREATED, createdProduct,
                ProductConstants.MESSAGE_CREATED);
    ...
    public ResponseEntity<ResponseDto<Void>> createSampleProducts(
        ...
        ResponseDto<Void> responseDto = new ResponseDto<>(HttpStatus.CREATED, null,
                ProductConstants.MESSAGE_SAMPLE_CREATED);
        return ResponseEntity.status(HttpStatus.CREATED).body(responseDto);
    }
